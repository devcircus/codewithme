<template>
    ...
    <svg v-else-if="name === 'notification'" xmlns="http://www.w3.org/2000/svg" class="w-8 mr-4 icon-notification" viewBox="0 0 24 24"><circle class="secondary" cx="12" cy="19" r="3" /><path class="primary" d="M 10.02 4.28 L 10 4 a 2 2 0 1 1 3.98 0.28 A 7 7 0 0 1 19 11 v 5 a 1 1 0 0 0 1 1 a 1 1 0 0 1 0 2 H 4 a 1 1 0 0 1 0 -2 a 1 1 0 0 0 1 -1 v -5 a 7 7 0 0 1 5.02 -6.72 Z" /></svg>
    ...
    <svg v-else-if="name === 'users'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-white"><path d="M7 8a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0 1c2.15 0 4.2.4 6.1 1.09L12 16h-1.25L10 20H4l-.75-4H2L.9 10.09A17.93 17.93 0 0 1 7 9zm8.31.17c1.32.18 2.59.48 3.8.92L18 16h-1.25L16 20h-3.96l.37-2h1.25l1.65-8.83zM13 0a4 4 0 1 1-1.33 7.76 5.96 5.96 0 0 0 0-7.52C12.1.1 12.53 0 13 0z" /></svg>
    <svg v-else-if="name === 'calendar'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path class="primary" d="M5 4h14a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2zm0 5v10h14V9H5z"></path><path class="secondary" d="M7 2a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1zm10 0a1 1 0 0 1 1 1v3a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1z"></path></svg>
    <svg v-else-if="name === 'calendar-date'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M5 4h14a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2zm0 5v10h14V9H5z"></path><path d="M13 13h3v3h-3v-3zM7 2a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1zm10 0a1 1 0 0 1 1 1v3a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1z"></path></svg>
    <svg v-else-if="name === 'clock'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><circle cx="12" cy="12" r="10"></circle><path class="secondary" d="M13 11.59l3.2 3.2a1 1 0 0 1-1.4 1.42l-3.5-3.5A1 1 0 0 1 11 12V7a1 1 0 0 1 2 0v4.59z"></path></svg>
</template>
