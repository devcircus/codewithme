    ...
    <div>
        ...
        <div class="flex flex-col">
            <div class="min-h-screen flex flex-col" @click="hideDropdownMenus">
                <div class="md:flex">
                    <div class="bg-indigo-700 md:flex-no-shrink md:w-56 px-6 py-4 flex items-center justify-between md:justify-center">
                    ...
                    <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-base flex justify-between items-center">
                        ...
                        <dropdown class="mt-1" placement="bottom-end">
                            <div class="flex items-center cursor-pointer select-none group">
                                <div class="text-gray-700 group-hover:text-indigo-700 focus:text-indigo-700 mr-1 whitespace-no-wrap">
                                    <span>{{ page.props.auth.user.first_name }}</span>
                                    <span class="hidden md:inline">{{ page.props.auth.user.last_name }}</span>
                                </div>
                                <icon class="w-5 h-5 group-hover:fill-indigo-700 fill-gray-700 focus:fill-indigo-700" name="cheveron-down" />
                            </div>
                ...
                <div class="flex flex-grow">
                    <div class="bg-indigo-700 flex-no-shrink w-56 p-12 hidden md:block">
                        <main-menu />
                    </div>
