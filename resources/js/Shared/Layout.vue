    ...
    <div>
        ...
        <div class="flex flex-col">
            <div class="min-h-screen flex flex-col" @click="hideDropdownMenus">
                <div class="md:flex">
                    <div class="bg-blue-800 md:flex w-full md:w-2/7 lg:w-1/7 md:flex-none px-6 py-4 flex items-center justify-between md:justify-center">
                        <inertia-link class="mt-1" href="/">
                            <text-logo class="fill-white w-140p lg:w-160p" />
                        </inertia-link>
                    ...
                    <div class="bg-white border-b p-4 md:py-0 md:px-12 w-full md:w-5/7 lg:w-6/7 text-sm md:text-base flex justify-between items-center">
                        <div class="mt-1 mr-4">
                ...
                <div class="flex flex-grow w-full">
                    <div id="side-bar" class="bg-blue-600 flex-no-shrink w-2/7 lg:w-1/7 p-12 hidden md:block">
                        <main-menu />
                    </div>
                    <div id="main-content" class="overflow-hidden px-4 py-8 md:p-12 w-full md:w-5/7 lg:w-6/7">
                        <slot />
                    </div>
                </div>
            </div>
